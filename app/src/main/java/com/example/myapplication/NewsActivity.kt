...
class NewsActivity : ContentActivity() {
    override fun content(textView: TextView): CharSequence {
        return textView.rich {
            ...
            img("https://img-xhpfm.zhongguowangshi.com/News/202004/XxjfyxC007001_20200407_CBMFN0A003.jpg")
            {
            ...
            img("https://img-xhpfm.zhongguowangshi.com/News/202004/XxjfyxC007001_20200407_CBMFN0A007.jpg")
            {
                width = textView.width
                keepRatio = true
            }
            +"世卫组织赴中国考察专家组负责人布鲁斯·艾尔沃德说：“在中国，我们还听到人们反复说一句了不起的话，就是抗‘疫’不仅仅是为了自己，更是为了全世界。”"
            img("https://img-xhpfm.zhongguowangshi.com/News/202004/XxjfyxC007001_20200407_CBMFN0A002.jpg")
            {
                width = textView.width
                keepRatio = true
            }
            ...
            +"""
            英国剑桥大学高级研究员马丁·雅克：“中国政府应对疫情非常高效。中国政府能从大局和战略上着想，有能力调动人力和资源，
            有很强统领能力。我认为中国的治理体系理当是世界上最高效的。”
            """.trimIndent()

            img("https://img-xhpfm.zhongguowangshi.com/News/202004/XxjfyxC007001_20200407_CBMFN0A004.jpg")
            {
                width = textView.width
                keepRatio = true
            }
            ...
            img("https://img-xhpfm.zhongguowangshi.com/News/202004/XxjfyxC007001_20200407_CBMFN0A005.jpg")
            {
                width = textView.width
                keepRatio = true
            }

            +"除了政府间援助，中国地方政府、企业、民间机构等还多次向相关国家提供援助。多层次、多渠道援助体现了中国勠力同心、"
            +"共克时艰的大爱精神，彰显了人类命运共同体的理念和担当，赢得国际社会高度赞誉。"

            img("https://img-xhpfm.zhongguowangshi.com/News/202004/XxjfyxC007001_20200407_CBMFN0A006.jpg")
            {
                width = textView.width
                keepRatio = true
            }
